...
const controls = {
  ...
  dailyWebhook: ['DAILY_WEBHOOK_HMAC', 'verifySignature('],
  dailyWebhookSetup: ['DAILY_WEBHOOK_SETUP_SECRET', 'providedSetupSecret !== expectedSetupSecret'],
...
const manifest = {
  ...
  'consultation-attendance-action': ['user'],
  ...
  'release-settlement-tranche': ['cron'],
  'reverse-stripe-transfer': ['cron'],
  'release-order-tip': ['cron'],
  'release-consultation-earning': ['cron'],
