        ...
        <View style={styles.body}>
          ...
          <View style={styles.noteCard}>
            ...
            <Text style={styles.noteCopy}>
              Email {CONTACTS.privacy} from your account email if anything about the request
              changes.
            </Text>
          </View>
        ...
        >
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.sectionCopy}>
              ...
              orders, Drapeon resolves refunds, disputes, and legally required records before final
          ...
          <View style={styles.noteCard}>
            ...
            <Text style={styles.noteCopy}>
              ...
              an instant wipe while money movement, support, or legal retention obligations may
              still be open.
            </Text>
          </View>
