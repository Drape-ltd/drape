    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      <KeyboardAwareScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.body}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.sectionCopy}>Your account can be restricted and queued for deletion review. If you have active orders, payouts, disputes, or legal retention obligations, Drapeon resolves those before final deletion or anonymization.</Text>
        ...
        <View style={styles.noteCard}>
          ...
          <Text style={styles.noteCopy}>Use this flow when you want Drapeon to process account closure and deletion. It is not an instant wipe while active orders, payouts, support cases, or legal retention obligations may still be open.</Text>
        </View>
