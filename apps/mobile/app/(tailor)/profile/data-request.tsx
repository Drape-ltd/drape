...
export default function TailorDataRequestScreen() {
  ...
  function goBack() {
    router.replace('/(tailor)/profile/privacy' as never)
  }
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.body}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.sectionCopy}>Profile details, phone number, notification preferences, and privacy preferences can be updated directly without a formal request.</Text>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.sectionCopy}>Optional, but helpful if you want the privacy team to focus on seller, payout, or order-history records first.</Text>
          <TextInput
