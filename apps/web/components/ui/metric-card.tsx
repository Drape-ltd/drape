...
export function MetricCard({
  ...
  return (
    <div
      className={cn(
        'min-w-0 rounded-[8px] border border-ui-border bg-white p-4 shadow-sm',
        className
      )}
    >
      <div className="flex items-start justify-between gap-3">
        ...
        {icon ? (
          <div className="grid size-9 shrink-0 place-items-center rounded-[8px] bg-ui-muted text-drape-green">
            {icon}
          </div>
        ) : null}
      </div>
