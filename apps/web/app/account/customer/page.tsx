    ...
    >
      ...
      <section className="border-t border-ink/6 py-16">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          ...
          <a href={`mailto:${CONTACTS.support}?subject=Customer%20account%20help`} className="rounded-[8px] border border-ink/6 bg-white/82 p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(22,28,24,0.10)]">
          ...
          <a
            href={buildWhatsAppSupportUrl('Hi Drapeon, I need customer account help.')}
            target="_blank"
