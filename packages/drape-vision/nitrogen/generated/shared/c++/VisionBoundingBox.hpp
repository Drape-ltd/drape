...
namespace margelo::nitro::drape::vision {
  ...
  /**
   * A struct which can be represented as a JavaScript object (VisionBoundingBox).
   */
  struct VisionBoundingBox final {
  public:
  ...
  public:
    VisionBoundingBox() = default;
    explicit VisionBoundingBox(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const VisionBoundingBox& lhs, const VisionBoundingBox& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ VisionBoundingBox <> JS VisionBoundingBox (object)
  template <>
  struct JSIConverter<margelo::nitro::drape::vision::VisionBoundingBox> final {
    static inline margelo::nitro::drape::vision::VisionBoundingBox fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::drape::vision::VisionBoundingBox(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::drape::vision::VisionBoundingBox& arg) {
