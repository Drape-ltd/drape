-- Expose the push-receipt reconciler through the protected readiness RPC.
-- The cron job was installed with the receipt ledger migration, but the health
-- function intentionally reports only an explicit allowlist of required jobs.
