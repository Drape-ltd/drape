-- Supabase projects can enforce safe-update semantics inside RPCs. Preserve the
-- idempotent backfill while making the intentionally broad update scope
-- explicit with WHERE clauses.
