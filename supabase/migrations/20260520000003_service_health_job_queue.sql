...
revoke all on function public.get_drape_service_health() from public;
revoke all on function public.get_drape_service_health() from anon;
revoke all on function public.get_drape_service_health() from authenticated;
